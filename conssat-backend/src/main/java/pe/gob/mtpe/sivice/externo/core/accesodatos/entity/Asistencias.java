...
public class Asistencias implements Serializable {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQTBD_ASISTENCIAS")
	@SequenceGenerator(name = "SEQTBD_ASISTENCIAS", sequenceName = "SEQ_TBD_ASISTENCIAS", allocationSize = 1)
