...
@Entity
@Table(name = "TBX_TIPO_COMISIONES")
public class TipoComisiones implements Serializable {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE,generator="SEQTBX_TIPO_COMISIONES") 
	@SequenceGenerator(name="SEQTBX_TIPO_COMISIONES",sequenceName="SEQ_TBX_TIPO_COMISIONES", allocationSize=1) 
	...
	public Long gettIpocomsidpk() {
		return tIpocomsidpk;
	}

	public void settIpocomsidpk(Long tIpocomsidpk) {
		this.tIpocomsidpk = tIpocomsidpk;
	}
