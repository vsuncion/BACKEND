...
@Entity
@Table(name = "TBX_TIPO_TEMAS")
public class TipoTemas implements Serializable {
	...
	public Long gettIpotemaidpk() {
		return tIpotemaidpk;
	}

	public void settIpotemaidpk(Long tIpotemaidpk) {
		this.tIpotemaidpk = tIpotemaidpk;
	}
