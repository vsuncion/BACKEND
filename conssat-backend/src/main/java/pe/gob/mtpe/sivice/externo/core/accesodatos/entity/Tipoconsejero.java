...
@Entity
@Table(name = "TBX_TIPOCONSEJERO")
public class Tipoconsejero implements Serializable {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE,generator="SEQTBX_TIPOCONSEJERO") 
	@SequenceGenerator(name="SEQTBX_TIPOCONSEJERO",sequenceName="SEQ_TBX_TIPOCONSEJERO", allocationSize=1) 
	...
	public Long gettPconsejeroidpk() {
		return tPconsejeroidpk;
	}

	public void settPconsejeroidpk(Long tPconsejeroidpk) {
		this.tPconsejeroidpk = tPconsejeroidpk;
	}
